...
var file = cljs.core.get.call(null,map__19078__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__19078__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__19078__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e19077){var _e = e19077;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5455__auto___19080 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5455__auto___19080)){
var seen_errors_19081 = temp__5455__auto___19080;
if(cljs.core.truth_(seen_errors_19081.has(self))){
} else {
seen_errors_19081.add(self);

var temp__5457__auto___19082 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5457__auto___19082)){
var sense_19083 = temp__5457__auto___19082;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_19083)].join('');
} else {
}
}
} else {
